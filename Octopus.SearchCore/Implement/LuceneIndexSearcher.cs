...
public class LuceneIndexSearcher : ILuceneIndexSearcher
{
    ...
    public LuceneIndexSearcher(Lucene.Net.Store.Directory directory, Analyzer analyzer, IMemoryCache memoryCache)
    {
    ...
    private ILuceneSearchResultCollection PerformSearch(SearchOptions options, bool safeSearch)
    {
        ...
        // var testDoc = searcher.Doc(0);
        // var testDoc2 = searcher.Doc(1);
        // var testDoc3 = searcher.Doc(2);
